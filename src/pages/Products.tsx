...
const products = [
  ...
  { title: "Water Systems", description: "Water pumps, storage tanks, and related water system equipment.", image: waterImg },
  ...
  { title: "Agricultural & Safety Equipment", description: "Pesticides, protective overalls, gloves, boots, and safety gear.", image: agriImg },
  { title: "Medical Equipment", description: "Selected medical equipment supplied to healthcare institutions.", image: medicalImg },
];
  ...
  <div>
    <section className="gradient-hero py-24">
      <div className="container text-center">
        <h1 className="text-4xl md:text-5xl font-heading font-bold text-primary-foreground mb-4">Products & Services</h1>
        <p className="text-primary-foreground/80 max-w-xl mx-auto text-lg">
          Quality products across multiple categories — everything your business needs from one supplier.
        </p>
      </div>
    </section>
